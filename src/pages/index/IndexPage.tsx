      ...
      <>
          ...
          <FullscreenCenter>
              <div className="text-center">
                  ...
                  <p><Link to="/dash">Dash</Link>•<Link to="/graphs">Graphs</Link>•<Link to="/dash-2">With column</Link>•<Link to="/dash-3">With lots of tiles</Link>•<Link to="/dash-4">With weird stuff</Link></p>
